...
export const metadata: Metadata = {
  title: "ATS Resume Optimizer — AI-Powered Resume Intelligence",
  description:
    "Upload your resume, sync LinkedIn data via Apify, and get Gemini-powered ATS suggestions to land more interviews.",
};
